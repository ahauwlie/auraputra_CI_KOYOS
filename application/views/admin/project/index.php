          ...
          <table id="productTable" class="table-bordered table-hover" style="table-layout: auto; width: 100%; ">
            ...
            <?php
              foreach ($project as $row) {
                  ...
                  echo "<td>".$row['kategori_pro']."</td>";
                  echo "<td>".$row['judul_pro']."</td>";
                  echo "<td>".$row['mini_text_pro']."</td>";
                  echo "<td>".$row['isi_pro']."</td>";
                  echo "<td>".$row['nama_client_pro']."</td>";
                  echo "<td>".$row['lokasi_pro']."</td>";
                  echo "<td>".$row['img_1_pro']."</td>";
                  echo "<td>".$row['img_2_pro']."</td>";
                  echo "<td>".$row['img_3_pro']."</td>";
                  echo "<td>".$row['img_4_pro']."</td>";
